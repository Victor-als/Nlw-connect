      ...
      <div className="min-h-dvh flex justify-center gap-16 flex-col">
        <div className="flex flex-col gap-8 items-center md:items-start w-full 
         max-w-[550px]">
          ...
          <h1 className='text-4xl text-center leading-none font-heading font-medium
         ...
         <div className='flex gap-5 items-strech flex-col md:flex-row'>
            <div className='flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-5'>
                ...
                <p className='text-gray-300 leading-relaxed text-sm md:text-base'>
                 ...
                 mergulhar nas tendências mais recentes em desenvolvimento de software, 
          ...
          <form 
            className='bg-gray-700 border border-gray-600 rounded-2xl p-8 
             space-y-6 w-full md:max-w-[440px]'
            action=""
          >
